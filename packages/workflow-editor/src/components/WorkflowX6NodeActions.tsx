 ...
 *
 * @param props 当前单选节点、组合/断点状态及由创作层提供的删除等窄命令。
 * @returns 无节点操作和删除入口时返回 null；多选节点或连线仍可展示删除入口。
